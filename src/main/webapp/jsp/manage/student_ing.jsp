...
<div class="Wrapbody">
    ...
    <div class="ulDiv">
        <ul>
            ...
            %>
            <li>
                <a href="exam.jsp?examid=<%=exam.get(i).getExaminationID()%>&examname=<%=exam.get(i).getExaminationName()%>&studentid=<%=userid%>&studentname=<%=username%>"
                   target="_top">
                    <div class="Mconright">
                        <h3 class="clearfix"><%=exam.get(i).getExaminationName()%>
                        </h3>
                        <p>任课教师：<%=teacherName.get(0)%>
                        </p>
