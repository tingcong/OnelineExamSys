$(function() {
	...
	$("#set_submit").on('click',function(){
		console.log(1);
		$.ajax({
			method: 'GET',
			url: '../handle/teacherSet.jsp',
			dateType: 'json',
			data: {
				examid:examid,
				totalScore:t,
				examTime:Vtime,
				difficulty:Vlevel,
				numberOfSingleChoice:sn,
				perScoreOfSingleChoice:sp,
				numberOfMultiChoice:mn,
				perScoreOfMultiChoice:mp,
				numberOfJudgment:jn,
				perScoreOfJudgment:jp,
				numberOfEssay:en,
				perScoreOfEssay:ep
			},
			success:function() {
